#!/usr/bin/env node
// Modified 2026-09-12: document the isolated year queue path.
...
Runtime notes:
  ...
  queue - sends requests to the SketchUp Ruby plugin through ~/.sketchup-mcp/versions/<YEAR>. Live mutations require --session-contract-file, or explicit same-command --fresh-handshake.
`);
}
