...
import { preflightDesignBrief } from './design-brief.mjs';
import { getVersionProfile, versionRegistry } from './sketchup-versions.mjs';
...
export class SketchUpBridge {
  ...
  async preflight_design_brief(options = {}) {
    return preflightDesignBrief(options);
  }

  async get_supported_versions() {
    return { selected: getVersionProfile(), profiles: structuredClone(versionRegistry.profiles), host_verification_required: true };
  }
